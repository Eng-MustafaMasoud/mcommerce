  ...
  return (
    <div className="fixed right-0 top-[50%] translate-y-[-50%] z-20 flex flex-col rounded-lg  gap-4   ">
      ...
      <Link href="/cart" className="flex  relative  flex-col items-center justify-center   ">
        ...
        <span className="absolute h-4 w-4 bg-black right-[45%]  top-[15%] translate-y-[-50%] translate-x-[50%]  flex justify-center items-center text-white rounded-full text-xs ">
          0
        </span>
      </Link>
    </div>
